...
El conjunto de estados visitados puede llegar a almacenar hasta $m!$ configuraciones distintas, cada una de longitud $m$.
...
- Para este problema concreto, sigue siendo mejor utilizar [greedy](0765_couples_holding_hands-greedy.md), que evita explorar combinaciones y resuelve el problema en tiempo lineal.
...
Frente a [greedy](0765_couples_holding_hands-greedy.md), la diferencia es más fuerte: greedy no necesita explorar ramas alternativas ni mantener una mejor solución parcial, porque corrige cada banco con una decisión local segura y obtiene el óptimo en una sola pasada.
