...
> **Consejo del Sabio Ermitage:** El caso (c) se resuelve con el **mínimo de la mitad izquierda** y el **máximo de la mitad derecha**. Ambos pueden calcularse en $O(n)$ en total. La recurrencia resultante es `T(n) = 2·T(n/2) + O(n)`. ¿A qué caso del Teorema Maestro corresponde?
